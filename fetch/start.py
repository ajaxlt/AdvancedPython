...
class myFecth():
    ...
    def selectLeague(self):
        ...
        try:
            ...
            threads = []
            t1 = myThread(nb.selectLeague, [self.driver_nbb, self.league_info, self.league_flag, 1], 'select newbb league')
            t2 = myThread(wb.selectLeague, [self.driver_tou, self.league_info, self.league_flag, 1], 'select toutou league')
    ...
    def getGameNode(self):
        ...
        try:
            ...
            t1 = myThread(nb.getGameNode, [self.driver_nbb, self.league_info, self.newbb_game_xpath], 'get all newbb game node')
            t2 = myThread(wb.getGameNode, [self.driver_tou, self.league_info, self.toutou_game_xpath], 'get all toutou game node')
